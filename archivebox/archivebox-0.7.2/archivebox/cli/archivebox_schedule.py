...
def main(
    ...
    group.add_argument(
        ...
        action="store_true",
        help=(
            "Launch ArchiveBox scheduler as a long-running foreground task "
    ...
    group.add_argument(
        ...
        action="store_true",
        help=(
            "Run all the scheduled jobs once immediately, independent of "
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Check this path and import any new links on every run "
